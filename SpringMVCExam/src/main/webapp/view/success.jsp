				...
				<div class="col-md-9" id="content">
					<div class="tab-content">
   					<div role="tabpanel" class="tab-pane active" id="Customer">
   						<div class="row">
   							<h3>客户管理</h3>
   							<button type="button" class="btn btn-primary "><a href="findcustomer.do" class="mya">查询</a></button>
      								...
      								<div class="modal-body">
      									<div calss="row">
      										<div class="col-md-12">
       										...
       										<form action="addcustomer.do" method="post" class="col-md-5" name="form1" >   
    										...
    										<option>请选择</option>
    										<c:forEach items="${addressList}" var="itema">
													<option value="${itema.addressId }">${itema.address }</option>
											</c:forEach>
    										</select>
  											</div>
  											<button type="submit" class="btn btn-default" onclick="check()">确认</button>
											</form> 
											</div>
									    </div>
      								</div>
							...
							<div  style="height:400px; overflow:auto;">
   							<table class="table table-hover">
								 ...
								 <c:forEach items="${itemsList }" var="item">
									<tr>
										<td><button type="button" class="btn btn-active ">del</button></td>
